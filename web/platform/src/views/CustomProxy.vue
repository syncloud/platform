  ...
  <div class="wrapper">
    <div class="content">
      <div class="block1 wd12">
        <h1 data-testid="customproxy-title">{{ $t('customProxy.title') }}</h1>
        <div class="row-no-gutters settingsblock">
          <div class="col2" :style="{ visibility: visibility }">
            ...
            <div v-for="proxy in proxies" :key="proxy.name" class="setline proxy-entry" style='display: flex; align-items: center;'>
              <a class="proxy-label" :href="'https://' + proxy.name + '.' + domain" target="_blank" :data-testid="'proxy-link-' + proxy.name">{{ proxy.name }}</a>
