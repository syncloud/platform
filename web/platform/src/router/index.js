...
const routes = [
  ...
  { path: '/appcenter', name: 'AppCenter', component: () => import('../views/AppCenter.vue'), meta: { admin: true } },
  { path: '/settings', name: 'Settings', component: () => import('../views/Settings.vue'), meta: { admin: true } },
  { path: '/activation', name: 'Activation', component: () => import('../views/Activation.vue'), meta: { admin: true } },
  { path: '/activate', name: 'Activate', component: () => import('../views/Activate.vue'), meta: { admin: true } },
  ...
  { path: '/support', name: 'Support', component: () => import('../views/Support.vue'), meta: { admin: true } },
  ...
  { path: '/twofactor', name: 'TwoFactor', component: () => import('../views/TwoFactor.vue'), meta: { admin: true } },
  { path: '/logs', name: 'Logs', component: () => import('../views/Logs.vue'), meta: { admin: true } },
  { path: '/customproxy', name: 'CustomProxy', component: () => import('../views/CustomProxy.vue'), meta: { admin: true } },
  ...
  { path: '/locale', name: 'Locale', component: () => import('../views/Locale.vue'), meta: { admin: true } },
